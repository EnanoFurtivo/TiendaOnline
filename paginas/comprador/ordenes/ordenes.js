var comprador_ordenes = {
    ...
    abrir_modal: function(id)
    {
        page = this;
        $.ajax({
            url: 'paginas/comprador/ordenes/get-orden.php',
            type: 'POST',
            async: true,
            data: {id_orden: id},
    ...
    cancelar_orden: function () 
    {
        id = cur_id;
        page = this;
        $.ajax({
            url: 'paginas/comprador/ordenes/cancelar-orden.php',
            type: 'POST',
            async: true,
            data: {id_orden: id},
            success: function(response)
    ...
    modificar_valores_modal: function(orden)
    {
        ...
        document.getElementById("productos-modal-footer-cancel").hidden = (orden.estado == "finalizada");
    }
};
